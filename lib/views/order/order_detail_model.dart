...
class Orders {
  ...
  Orders.fromJson(Map<String, dynamic> json) {
    ...
    deliveryBoy = json['delivery_boy'] != null ? new DeliveryBoy.fromJson(json['delivery_boy']) : null;
