...
class AppTheme {
  ...
  static final ThemeData lightTheme = ThemeData(
    ...
    primaryColor: const Color(0xff15cb95),
    ...
    floatingActionButtonTheme: FloatingActionButtonThemeData(
        ...
        elevation: 4,
        focusColor: const Color(0xff15cb95),
        hoverColor: const Color(0xff15cb95),
    ...
    sliderTheme: SliderThemeData(
      activeTrackColor: const Color(0xff15cb95),
      inactiveTrackColor: const Color(0xff15cb95).withAlpha(140),
      trackShape: const RoundedRectSliderTrackShape(),
      trackHeight: 4.0,
      thumbColor: const Color(0xff15cb95),
      ...
      valueIndicatorTextStyle: const TextStyle(
        ...
        onBackground: Color(0xff495057)).copyWith(background: Colors.white).copyWith(error: const Color(0xfff0323c)),
  );
  static ThemeData darkTheme = ThemeData(
      ...
      sliderTheme: SliderThemeData(
        activeTrackColor: const Color(0xff15cb95),
        inactiveTrackColor: const Color(0xff15cb95).withAlpha(100),
        trackShape: const RoundedRectSliderTrackShape(),
        trackHeight: 4.0,
        thumbColor: const Color(0xff15cb95),
        thumbShape: const RoundSliderThumbShape(enabledThumbRadius: 10.0),
      ...
      ).copyWith(background: const Color(0xff464c52)).copyWith(error: Colors.orange));
  ...
  static NavigationBarTheme getNavigationThemeFromMode(int themeMode) {
    ...
    if (themeMode == themeLight) {
      ...
      navigationBarTheme.selectedItemColor = const Color(0xff15cb95);
      navigationBarTheme.unselectedItemColor = const Color(0xff495057);
      navigationBarTheme.selectedOverlayColor = const Color(0x3815cb95);
    } else if (themeMode == themeDark) {
